...
export const LocationSection: React.FC = () => {
  ...
  return (
    <section id="location" className="py-10 sm:py-16 bg-[#FAF6F0] relative overflow-hidden border-t border-[#2B1810]/5 select-none">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6 sm:space-y-8 relative z-10">
        ...
        <div className="bg-white p-3 sm:p-5 rounded-3xl border-2 border-[#CBB279]/40 shadow-xl">
          ...
          <div className="w-full h-72 sm:h-96 md:h-[450px] rounded-2xl overflow-hidden border border-[#2B1810]/10 shadow-inner relative group bg-[#FAF6F0]">
            <iframe
            ...
            <div className="absolute top-3 left-3 sm:top-4 sm:left-4 bg-[#2B1810]/90 backdrop-blur-md text-white px-3 py-1.5 sm:px-4 sm:py-2 rounded-2xl text-[11px] sm:text-xs font-bold flex items-center space-x-2 shadow-lg border border-[#CBB279]">
              <span className="w-2.5 h-2.5 rounded-full bg-emerald-400 animate-ping" />
              <span>📍 DINORA Pastry & Art</span>
            </div>

            {/* Quick External Map Redirect Overlay Buttons */}
            <div className="absolute bottom-3 right-3 sm:bottom-4 sm:right-4 flex flex-col xs:flex-row gap-2">
              <a
                href={exactGoogleMapUrl}
                target="_blank"
                rel="noopener noreferrer"
                className="min-h-[38px] bg-[#2B1810] hover:bg-[#3D2318] text-[#FAF6F0] px-3 py-2 rounded-xl text-xs font-bold shadow-md flex items-center justify-center space-x-1.5 border border-[#CBB279] active:scale-95 transition-all touch-manipulation"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="min-h-[38px] bg-[#D65B78] hover:bg-[#c24b67] text-white px-3 py-2 rounded-xl text-xs font-bold shadow-md flex items-center justify-center space-x-1.5 active:scale-95 transition-all touch-manipulation"
              >
                <Navigation className="w-4 h-4" />
                <span>{t('location.nav_btn')}</span>
